 ...
 *
 */
public class QuoteServerFlow extends MiniWFlow {

    Work show_quote=new Work() {
        public void eval(Job job, Object arg) {
            StockQuoteEvent ev= (StockQuoteEvent) job.getEvent();
            System.out.println( "*******************************************");
            System.out.println( "Symbol: " + ev.getTicker());
            System.out.println( "Price: " + ev.getPrice());
            System.out.println( "Change: " + ev.getChange());
            System.out.println( "===========================================");
        }
    };
    
    
    public QuoteServerFlow(Job job) {
        super(job);
    }
        ...
        protected Activity onStart() {
            return new PTask( new Work() {
                public void eval(Job job, Object closure) throws Exception {
                    System.out.println("Demo reading stock quotes..." );
                }
            });
        }
    }
