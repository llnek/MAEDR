...
public class MockTopicConnection implements TopicConnection {
     ...
     * @param pwd
     */
    public MockTopicConnection(String user, String pwd)    {
        this();
    }
    ...
    @Override
    public TopicSession createTopicSession(boolean transact, int ack)
            throws JMSException {
        MockTopicSession s= new MockTopicSession(this, transact, ack);
        s.run();
        return s;
    }
