 ...
 *
 */
public class RepeatTimerService extends TimerMulti<RepeatTimerService> {
     ...
     * @return
     */
    public static RepeatTimerService create(int delaysecs, int intervalsecs) {
        return new RepeatTimerService(intervalsecs).delaysecs(delaysecs);
    }
     ...
     * @return
     */
    public static RepeatTimerService create(int intervalsecs) {
        return new RepeatTimerService(intervalsecs);
    }
     ...
     * @return
     */
    public RepeatTimerService handler(TimerHandler h) {
        _hdlr=h;
        return this;
    }
    ...
    protected Device newDevice(DeviceManager<?,?> m) throws Exception {
        return new RepeatingTimer(m);
    }

    private RepeatTimerService(int secs) {
        super(secs);
    }
