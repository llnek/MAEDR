 ...
 *
 */
public class WhileStep extends ConditionalStep {

	private FlowStep _body;

	/**
	 * @param s
	 * @param a
	 */
	public WhileStep(FlowStep s, While a) {
		super(s,a);
	}
	...
	public FlowStep eval(Job job) throws Exception {
	    Object c= popClosureArg(); // data from previous async call ?
		FlowStep rc= this;
	 ...
	 * @return
	 */
	public WhileStep withBody(FlowStep body) {
		_body=body;
        return this;
	}
