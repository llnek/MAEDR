 ...
 *
 */
public class FlowServiceGroup extends ServiceGroup<MiniWFlow,FlowStep> {

	/**
	 * 
	 */
	public FlowServiceGroup() {}
	 ...
	 */
	@Override
	protected void bindCfg(AppEngine<MiniWFlow, FlowStep> eng) throws Exception {
