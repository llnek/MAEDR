 ...
 *
 */
public class ProcBaseEngine extends AppEngine<Processor, Processor> {
    
    private ProcModule _module= new ProcModule();
    
    
	/**
	 * 
	 */
	public ProcBaseEngine() {
		iniz();
	}
		
    /* (non-Javadoc)
     * @see com.zotoh.maedr.core.AppEngine#inizJobCreator()
     */
    protected JobCreator<Processor,Processor> inizJobCreator() {
        return new JobMaker(this);
    }
    
    /* (non-Javadoc)
     * @see com.zotoh.maedr.core.AppEngine#inizScheduler()
     */
