 ...
 *
 */
public class AsyncResumeToken extends FAsyncResumeToken<Processor> {

    /**
     * @param p
     */
    public AsyncResumeToken(Processor p) {
        super(p);
    }
    ...
    public void resume(Object resultArg) {
        Processor p=(Processor)_proc;
        p.attachClosureArg(resultArg);
        p.getEngine().getScheduler().reschedule(p);
    }
