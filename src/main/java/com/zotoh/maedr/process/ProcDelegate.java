 ...
 * 
 * @see com.zotoh.maedr.process.DefaultDelegate
 * 
 * @author kenl
 */
public abstract class ProcDelegate extends AppDelegate<Processor,Processor> {
    
    /**
     * @param eng
     */
    protected ProcDelegate(ProcBaseEngine eng)    {
    	super(eng);
    }
